...
<p>&nbsp;<?php echo $size;; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $color; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;RTN Width: <?php  echo $rtn; ?></p>
<p>&nbsp;<strong><?php echo $blinds; ?></strong></p>
<table width="603" border="0" class="center">
  <tr>
    <td width="277"><strong><?php echo $customer; ?></strong></td>
    <td width="316">Order&nbsp;&nbsp;&nbsp; <?php echo $index; ?> &nbsp;&nbsp;&nbsp;of&nbsp; &nbsp;&nbsp; <?php echo $total; ?> &nbsp; &nbsp;&nbsp;VAL</td>
  </tr>
</table>
</div>
</body>
